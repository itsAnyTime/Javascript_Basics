...
// 1. Marks und Johns Gewicht und Größe in Variablen.
let mark_gewicht = 68;
let mark_groesse = 180;
let john_gewicht = 72;
let john_groesse = 182;

// 2. Berechnung der BMIs, gespeichert in Variablen: 
// BMI = Gewicht / cm
...
// 3. Variable, die einen Wahrheitswert enthält. Ihr Wert drückt aus, ob Marks BMI größer ist als Johns.
let compare = true;
// let compare = mark_more = (bmi_mark > bmi_john)


// 4. Gibt eine Zeichenkette auf der Konsole aus, die die Variable aus Schritt 3 in einer Interpolation (template String) verwendet. (z. B. "Ist Marks BMI größer als Johns? [(true/false):(Ja ist er / Nein ist er nicht))] ")
...
/* 5. Erstellt eine wenn (if) Anweisung. Gibt damit den Namen und BMI der Person aus, die den größten BMI hat. */
if(bmi_mark > bmi_john) {
